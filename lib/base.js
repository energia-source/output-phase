(function (window) {
	...
	class Line {
		...
		static style(color) {
			...
			return properties.replaceAll('$s', Line.stroke()).replaceAll('$c', color);
		}
		...
		constructor(phase, title) {
			...
			this.elements.line.setAttribute(this.constructor.zx(), Phase.zero());
			this.elements.line.setAttribute(this.constructor.zy(), Phase.zero());
		...
		getX() {
			let l = this.getSize(),
				r = this.getRadians();
			return (Math.cos(r) * l) + Phase.zero();
		}
		getY() {
			let l = this.getSize(),
				r = this.getRadians();
			return (Math.sin(r) * l) + Phase.zero();
		}
		draw() {
